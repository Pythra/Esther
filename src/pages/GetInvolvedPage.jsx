  ...
  return (
    <div className="teg-page">
      <section className="teg-page-hero">
        <h1>Join our Prayer Ministry</h1>
        <p>Prayer watches, night prayers, and prayer stretches</p>
      </section>
      <section className="teg-page-content">
        <div className="teg-content-inner">
          <div className="teg-content-block">
            ...
            <p>
              Join our prayer ministry and grow in faith and intercession. Choose from prayer watches, night prayers, or extended prayer stretches.
            </p>
          </div>
          <div className="teg-content-block">
          ...
          <Link to="/prayer" className="teg-btn teg-btn-primary">More on Prayer Ministry</Link>
        </div>
      </section>
    </div>
  );
